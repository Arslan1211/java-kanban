...
class InMemoryTaskManagerTest {
  ...
  void getHistory() {
    ...
    Subtask subtask2 = new Subtask(epic1.getId(), "Написать курсовую", "Выбрать тему",
        Status.IN_PROGRESS);
    Subtask subtask3 = new Subtask(epic2.getId(), "Сдать диплом", "Подготовить презентацию",
        Status.DONE);
  ...
  void findAllSubtasks() {
    ...
    Subtask subtask2 = new Subtask(epic1.getId(), "Написать курсовую", "Выбрать тему",
        Status.IN_PROGRESS);
    Subtask subtask3 = new Subtask(epic1.getId(), "Сдать диплом", "Подготовить презентацию",
        Status.DONE);
